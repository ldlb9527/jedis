...
public class SearchProtocol {
  ...
  public enum SearchKeyword implements Rawable {
    ...
    SCHEMA, TEXT, TAG, NUMERIC, GEO, GEOSHAPE, VECTOR, VSIM, VERBATIM, NOCONTENT, NOSTOPWORDS, WITHSCORES,
    ...
    NOSORT, KNN, K, EF_RUNTIME, RANGE, RADIUS, EPSILON, YIELD_SCORE_AS, COMBINE, RRF, LINEAR,
    WINDOW, CONSTANT, ALPHA, BETA, POLICY, ADHOC_BF, BATCHES, BATCH_SIZE,
